...
echo "     - Cambiar 'Inputs pendientes de INTERLOCUTOR y de la clienta (centralizado)' por 'Resumen histórico de sesión 2026-08-09 (archivado)'."
...
echo "     - Quitar nota 'Bloqueado por: confirmación de roles específicos' y 'Bloqueado por elección de la clienta'."
