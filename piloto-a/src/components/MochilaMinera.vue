...
<template>
  <div class="mochila-overlay" @click.self="emit('close')">
    ...
    >
      ...
      <div
        v-if="activeTab === 'mochila'"
        id="panel-mochila"
        role="tabpanel"
        aria-labelledby="tab-mochila"
        class="tab-content mochila-grid-layout"
      >
      ...
      <div
        v-else-if="activeTab === 'bitacora'"
        id="panel-bitacora"
        role="tabpanel"
        aria-labelledby="tab-bitacora"
        class="tab-content bitacora-layout"
      >
        <div class="quests-list">
          ...
          >
            ...
            <div
              ...
              aria-valuemin="0"
              aria-valuemax="100"
              :aria-label="`Progreso de la misión: ${quest.progress}%`"
            >
