...
**Lota Indómito:** cliente de Sentinel, postulación a fondo público (cierre fines de agosto / primera semana de septiembre 2026)
**Cliente:** Fabiola (CLIENTA)
...
- **D-008** · El stack del juego lo elige Fabiola de un menú de opciones (P-004 abierto).
...
| `docs/estado.md` | 148 líneas | Modificado — Fabiola registrada en "Quién es quién" + sección 9 "Lecciones aprendidas" con referencia a skills oficiales de Sentinel y al doc 12 |
| `_analisis/08_carta_gantt_3_semanas.md` | 110 líneas | Nuevo — cronograma 3 semanas |
| `_analisis/09_presupuesto_referencial.md` | 124 líneas | Nuevo — desglose 10M CLP, Opción A y B |
| `_analisis/10_opciones_tecnologicas_para_clienta.md` | 101 líneas | Antes `06_*`, renombrado para liberar slot 06 |
| `_analisis/11_borrador_propuesta_fondo.md` | 185 líneas | Antes `07_*`, renombrado para liberar slot 07 |
...
**Cancelado** — pivote a menú de opciones para Fabiola (D-008, P-004). Se retoma según elección de Fabiola.
...
| 3 | Opción A (web progresiva) vs Opción B (videojuego Rust + servidor propio `lota-server`) | Fabiola |

### Tareas bloqueadas por las respuestas

- `_analisis/11_borrador_propuesta_fondo.md` sección 4 — ramas A/B según elección Fabiola, módulo buses según Pregunta 1, roles según Pregunta 2.
- `_analisis/09_presupuesto_referencial.md` — ramas A/B según elección Fabiola.
- `_analisis/08_carta_gantt_3_semanas.md` — alcance real según Pregunta 2.
- `_analisis/10_opciones_tecnologicas_para_clienta.md` — cerrar como comparativa o como opción única según Pregunta 3.
- `docs/decisiones.md` P-004 — registrar decisión de Fabiola.
...
?? _analisis/09_presupuesto_referencial.md                   (esta sesión)
?? _analisis/10_opciones_tecnologicas_para_clienta.md        (esta sesión, antes 06_*)
?? _analisis/11_borrador_propuesta_fondo.md                  (esta sesión, antes 07_*)
...
1. INTERLOCUTOR responde Preguntas 1 y 2 del doc 12 (cuando pueda, sin esperar a Fabiola).
2. Fabiola elige Opción A o B (reunión + decisión en P-004).
