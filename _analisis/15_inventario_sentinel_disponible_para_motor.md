...
- **NO usar Unity, OpenGL directo, Vulkan directo.** Unity es `f32` end-to-end. OpenGL y Vulkan como API están bien, pero exponerlos directamente rompe la portabilidad. **WGPU sí** — es el wrapper Rust sobre Vulkan/Metal/DX12/WebGPU que mantiene layout C-friendly y permite empaquetar SPA.
