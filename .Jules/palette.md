...
## 2024-09-04 - Accessible Modals with Backdrop Dismissal
**Learning:** Users expect to dismiss modals by clicking the background overlay, and screen readers require dialog roles.
**Action:** Always add @click.self on overlay and role=dialog with aria-modal on custom modals.
